...
# Agent Skill: local-orchestrator / SKILL.md
...
This skill optimizes workspace efficiency by offloading reasoning to local hardware, bridging cloud and local context to facilitate the **Architecture of Hybrid Context Synthesis**.
